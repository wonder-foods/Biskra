...
const MENU_DATA: MenuSection[] = [
  {
    ...
    accentColor: "#F5C518",
    items: [
      { id: "c1",  name: "SIMPLE",         desc: "Crêpe nature",                                price: 350,  badges: [] },
      ...
      { id: "c5",  name: "LOTUS",           desc: "Pâte à tartiner Lotus Biscoff",               price: 550,  badges: ["POPULAIRE"] },
      ...
      { id: "c15", name: "CREPE DUBAI",     desc: "La crêpe façon Dubaï — croustillante et fondante", price: 500, badges: ["NOUVEAU", "PROMO"] },
      { id: "c16", name: "CAKE DUBAI",      desc: "Le cake de Dubaï — expérience unique",        price: 1000, badges: ["PREMIUM"] },
      ...
      { id: "c21", name: "CREPES CHOCOLAT", desc: "Tout chocolat — le classique",                price: 400,  badges: [] },
    ]
  },
  {
    category: "NOS BOXS",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "ds2", name: "FONDANT CHOCOLAT",   desc: "Fondant au chocolat coulant",               price: 450, badges: [] },
      { id: "ds3", name: "CHEESECAKE",         desc: "Cheesecake New York style",                 price: 500, badges: [] },
      { id: "ds4", name: "SAINT-SÉBASTIEN",    desc: "Gâteau Saint-Sébastien — une merveille",    price: 600, badges: ["PREMIUM"] },
    ]
  },
  {
    category: "JUS FRAIS",
    ...
    accentColor: "#F5C518",
    items: [
      { id: "j1",  name: "ORANGE",           desc: "Jus d'orange pressé frais",   price: 300, badges: [] },
      { id: "j2",  name: "CITRON",           desc: "Limonade maison",              price: 300, badges: [] },
      { id: "j3",  name: "FRAISE",           desc: "Jus de fraise frais",          price: 300, badges: ["POPULAIRE"] },
      { id: "j4",  name: "PASTÈQUE",         desc: "Jus de pastèque désaltérant",  price: 200, badges: [] },
      { id: "j5",  name: "KIWI ORANGE",      desc: "Mix kiwi & orange",            price: 200, badges: [] },
      { id: "j6",  name: "ANANAS",           desc: "Jus d'ananas exotique",        price: 500, badges: [] },
      { id: "j7",  name: "POMME",            desc: "Jus de pomme pur fruit",       price: 400, badges: [] },
      { id: "j8",  name: "GRENADINE",        desc: "Sirop grenadine frais",        price: 300, badges: [] },
    ]
  },
  {
    category: "MILKSHAKES",
    ...
    items: [
      ...
      { id: "ms3", name: "OREO",                   desc: "Milkshake Oreo croustillant",           price: 500, badges: [] },
      { id: "ms4", name: "BUENO",                  desc: "Milkshake Kinder Bueno",                price: 500, badges: [] },
  ...
  },
  {
    ...
    accentColor: "#fff",
    items: [
      { id: "bc1", name: "CAFÉ",            desc: "Expresso serré",                price: 200, badges: [] },
      { id: "bc2", name: "THÉ",             desc: "Thé à la menthe",               price: 150, badges: [] },
      { id: "bc3", name: "CAPPUCCINO",      desc: "Cappuccino crémeux",            price: 250, badges: ["POPULAIRE"] },
      { id: "bc4", name: "CHOCOLAT CHAUD",  desc: "Chocolat chaud onctueux",       price: 300, badges: [] },
    ]
  },
];
